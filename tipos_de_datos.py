...
"""
 Dividir el string contenido en la variable `data` en donde se encuentre el primer caracter `\n` y guardar el resultado en una variable llamada var1.
"""
var1 = data.split('\n',1)
print('\n1. Dividir el string contenido en la variable `data` en donde se encuentre el primer caracter `\n` y guardar el resultado en una variable llamada `var1. \n')
print(var1)
...
apellidos = var1[0]
decimales = var1[1]
print('\n2.1 Guardar el primer elemento de la variable `var1` en una variable llamada `apellidos` y el segundo elemento en una llamada `decimales \n')
print(apellidos)
print('\n2.2 Decimales \n')
print(decimales)
...
print('\n3 Dividir el string contenido en la variable `apellidos` en donde se encuentre el caracter `,` y guardar el resultado en una variable llamada `apellidos_list`. \n')
...
"""
print('\n4 Dividir el string contenido en la variable `decimales` en donde se encuentre el caracter `;` y guardar el resultado en una variable llamada `decimales_list`. \n')
...
print('\n5. Obtener el elemento en la posición 38 de `decimales_list`, procesarlo para convertirlo en un entero y guardarlo en variable `var2` \n')
print(var2)
...
print('\n7. obtener la longitud (cantidad de caracteres) de la variable `apellido` y guardar el resultado en `len_apellido``.\n')
print (len_apellido)
